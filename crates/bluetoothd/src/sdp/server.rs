...
//
// These helpers MUST appear *before* the `#[cfg(test)] mod tests { ... }`
// block to satisfy clippy's `items_after_test_module` lint: the convention is
// that a `#[cfg(test)] mod tests` block is the final item in the file, and
// any other production/test-support items should precede it.
// ---------------------------------------------------------------------------
